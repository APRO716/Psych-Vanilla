...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["What a Funkin' Disaster!",	"Complete a Song with Misses more than Hits.",		'ur_bad',				false],
		["Perfectionist",				"Complete Any Song with no Misses",					'ur_good',				false],
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		achievementName.setFormat(Paths.font("font.ttf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 32, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("font.ttf"), 16, FlxColor.WHITE, LEFT);
