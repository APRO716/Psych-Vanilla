...
class NoteOffsetState extends MusicBeatState
{
	...
	var delayMin:Int = -500; // Credit https://github.com/ShadowMario/FNF-PsychEngine/pull/9847
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("font.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		changeModeText.setFormat(Paths.font("font.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("font.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
