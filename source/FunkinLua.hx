...
class FunkinLua {
	...
	public function new(script:String) {
		...
		//Identical functions
		Lua_helper.add_callback(lua, "FlxColor", function(?color:String = '') { return getColorByString(color); });
		Lua_helper.add_callback(lua, "getColorFromName", function(?color:String = '') { return getColorByString(color); });
		//
...
class ModchartText extends FlxText
{
	...
	public function new(x:Float, y:Float, text:String, width:Float)
	{
		...
		setFormat(Paths.font("font.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class DebugLuaText extends FlxText
{
	...
	public function new(text:String, parentGroup:FlxTypedGroup<DebugLuaText>, color:FlxColor) {
		...
		setFormat(Paths.font("font.ttf"), 16, color, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scrollFactor.set();
		borderSize = 1;
	}
